...
/**
 * 默认管道服务实现，主要用于加载每个模块的pipeline.xml文件，然后通过pipeline.xml文件中的配置 组装管道
 * 
 * @author GaoHang
 * 
 */
public class DefaultPipelineService implements PipelineService {
    ...
    public void service() {
        synchronized (lock) {
            ...
            ApplicationContextUtils.getApplicationContextHolder().set(ApplicationContextHolder.PIPELINE_CONTEXT,
